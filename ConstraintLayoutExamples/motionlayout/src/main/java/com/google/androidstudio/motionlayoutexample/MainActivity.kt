...
import com.google.androidstudio.motionlayoutexample.fragmentsdemo.FragmentExample4Activity
...
class MainActivity : AppCompatActivity(), CompoundButton.OnCheckedChangeListener {
    ...
    private val dataset: Array<DemosAdapter.Demo> = arrayOf(
            ...
            DemosAdapter.Demo("hehehe", "hehehe", FragmentExample4Activity::class.java),
